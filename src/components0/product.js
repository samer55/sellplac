...
export default class ProductPage extends Component {
    ...
    renderImage1() {
        ...
        return (
            <Animated.Image source={{ uri: "https://i.postimg.cc/76tHdWdh/Whats-App-Image-2019-03-24-at-8-40-07-PM.jpg" }} style={[styles.img, this.getImage1Style(), {left: px + 20, top: py - 30}]}/>
        )
    }
    ...
    renderImage2() {
        const {px, py} = this.state;
        return (
            <Animated.Image source={{ uri: "https://i.postimg.cc/rp8qmTLz/Whats-App-Image-2019-03-24-at-8-40-08-PM.jpg" }} style={[styles.img, this.getImage2Style(), {left: px + 20, top: py - 30}]}/>
        )
    }
            ...
            <View style={styles.cart}>
                ...
                <View style={{flexDirection: 'row', justifyContent: 'space-around', paddingTop: 20}}>
                    <View style={{width: 150, height: 100, backgroundColor: 'white'}}>
                        <Image source={{ uri: "https://i.postimg.cc/76tHdWdh/Whats-App-Image-2019-03-24-at-8-40-07-PM.jpg" }} style={{height: 120, width: 130}}/>
                    </View>
                    <View style={{width: 150, height: 100, backgroundColor: 'white'}}>
                        <Image source={{ uri: "https://i.postimg.cc/rp8qmTLz/Whats-App-Image-2019-03-24-at-8-40-08-PM.jpg" }} style={{height: 120, width: 130}}/>
                    </View>
